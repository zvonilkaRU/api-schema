...
func (x *ClientSugared) SendFriendRequest(ctx context.Context, req *SendFriendRequestRequest) (*friends.SendFriendRequestResponse, error) {
...
func (x *ClientSugared) AcceptFriendRequest(ctx context.Context, req *AcceptFriendRequestRequest) (*models.UserRefResponse, error) {
